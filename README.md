...
直接在线播放:[AI 同声传译助手演示](https://cdn.jsdelivr.net/gh/jsasmy/ai-interpreter@main/docs/demo.mp4)
...
仓库内文件：[docs/demo.mp4](https://github.com/jsasmy/ai-interpreter/blob/main/docs/demo.mp4)
